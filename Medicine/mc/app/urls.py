...
urlpatterns = [
    ...
    path('add-to-cart/',views.add_to_cart, name='ass-to-cart'),
   ...
   # path('logout/',auth_view.LogoutView.as_view(next_page='login') ,name='logout'),
    ...
    path('password-reset-confirm/<uibd64>/<token>',auth_view.PasswordResetConfirmView.as_view(template_name='app/password_reset_confirm.html',
    form_class=MySetPasswordForm),name='password_reset_confirm'),

    path('password-reset-commplete/', auth_view.PasswordResetCompleteView.as_view(template_name='app/password_reset_complete.html'),
